...
export const fullnameSchema = z.string().refine((value) => value.match(fullnamePattern), 'INVALID_FIO')
export const genderSchema = z.string().refine((value) => value.match(genderPattern), 'INVALID_GENDER')
export const passportSchema = z.string().refine((value) => value.match(passportPattern), 'INVALID_PASSPORT')
export const polisSchema = z.string().refine((value) => value.match(polisPattern), 'INVALID_POLIS')
